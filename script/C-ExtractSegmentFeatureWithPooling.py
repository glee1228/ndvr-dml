...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, choices=models.SEGMENT_MODELS,required=True)
    # parser.add_argument('--ckpt', type=str, default=None)
    parser.add_argument('--frame_feature_path', type=str, required=True)
    parser.add_argument('--segment_feature_path', type=str, required=True)
