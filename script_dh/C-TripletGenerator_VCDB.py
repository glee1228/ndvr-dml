...
if __name__ == '__main__':
    ...
    parser.add_argument('--triplet_csv', type=str, default='/mldisk/nfs_shared_/dh/VCDB/vcdb_triplets_1fps_semi_hard.csv')
    ...
    positive_csv = '/mldisk/nfs_shared_/dh/VCDB/vcdb_positive_1fps_Deduplication.csv'
