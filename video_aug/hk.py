...
if __name__ == '__main__':
    ...
    dataset_dir = '/mldisk/nfs_shared_/my_vlad/simulated_features/resnet_rmac_1fps/k16_512'
    vcdb_core_video = np.load('/workspace/for_process/vcdb_videos_core.npy')  # video path list
    added_videos = os.listdir('/mldisk/nfs_shared_/js/SIMULATED_DATASET/videos/original')
    vcdb_core_video = np.concatenate((vcdb_core_video, np.array(added_videos)))

    feature_path = '/mldisk/nfs_shared_/my_vlad/simulated_features/resnet_rmac_1fps_testdb'  # database
    ...
    # query_path = '/mldisk/nfs_shared_/my_vlad/simulated_features/resnet_rmac_1fps/k16_512/border/Light/0YY0RDbxSns.flv.pth'
