...
class MNIST_t(data.Dataset):
    ...
    def __init__(self, root, n_train_triplets=50000, n_test_triplets=10000, train=True, transform=None,
    ...
    def __getitem__(self, index):
        ...
        img1 = Image.fromarray(img1.numpy(), mode='L').convert("RGB")
        img2 = Image.fromarray(img2.numpy(), mode='L').convert("RGB")
        img3 = Image.fromarray(img3.numpy(), mode='L').convert("RGB")
